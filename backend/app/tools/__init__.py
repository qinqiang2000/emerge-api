...
def build_emerge_mcp(
    ...
    *,
    ...
    @tool(
        ...
        "is output-priced but counted apart from `output_tokens` (Gemini "
        "2.5+), so sum both for output spend. `bbox` is ALWAYS in PDF page units "

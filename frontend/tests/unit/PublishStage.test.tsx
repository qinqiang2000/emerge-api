...
describe('adaptReadiness', () => {
  ...
  it('parses a JSON string (the raw tool_result shape) and humanizes snake_case keys', () => {
    const json = JSON.stringify({
      ...
      soft_warnings: [], hard_pass: false, macro_f1: 0.97, n_reviewed: 5,
    })
    const out = adaptReadiness(json)
    ...
    // also still accepts an already-parsed object
    expect(adaptReadiness(JSON.parse(json))).toHaveLength(3)
  })
})

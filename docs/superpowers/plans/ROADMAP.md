...
| **M11** — turn as first-class resource (decouple SSE from turn lifetime; multi-client attach; "switch view doesn't kill the agent") + Phase B symmetry fillers (13 tool-only actions get HTTP counterparts; localStorage active-chat → backend-derived) | `2026-05-19-turn-as-resource.md` | 🚧 in progress | — |
